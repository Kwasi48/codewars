...
//the percentage of foam or gas lost every day (evap_per_day) and
...
void main() {
  int evaporator(double content, double evap_per_day, double threshold) {
    int days = 0;
    double max_percen = 100;
    while (max_percen > threshold) {
      max_percen = max_percen - (evap_per_day / 100) * max_percen;
      days = days + 1;
    }
    return days;
  }
